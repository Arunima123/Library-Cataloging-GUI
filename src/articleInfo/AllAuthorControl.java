...
public class AllAuthorControl implements Initializable {
	 ...
	 String[] columnNames = new String[] {"Author ID","Author Name","Author Email","Author Dept.","Author Address","Institution ID","Institution Name","Inst. State","Inst. City","Inst. Street"};
