...
public class AllJournalControl implements Initializable {
	 ...
	 String[] columnNames = new String[] {"Journal ID", "Journal Title", "No of Pages", "Year of Publishing","Publisher"};
