...
public class ArticleInfoControl implements Initializable {
	 ...
	 String[] columnNames = new String[] {"ID", "Title", "No of Pages", "Year of Publishing","Journal Title","Journal Pages","Journal Year","Journal Publisher","Author","Author Email","Author Dept.","Author Address","Institution","Inst. State","Inst. City","Inst. Street"};
